...
RULES = [
    {"key": "horaires", "confirm": False,
     "fr": "Arrivée entre 16h et 20h, départ entre 8h et 9h. En dehors de ces plages, notre accord écrit préalable est indispensable.",
     "en": "Check-in between 4 pm and 8 pm, check-out between 8 am and 9 am. Outside these times, our prior written agreement is required.",
    ...
    {"key": "capacite", "confirm": False,
     "fr": "12 personnes maximum, visiteurs compris. Aucune personne supplémentaire ne peut séjourner ou dormir dans la villa sans notre accord écrit.",
     "en": "12 people maximum, visitors included. No additional person may stay or sleep at the villa without our written agreement."},
    {"key": "fetes", "confirm": True,
     "fr": "Aucun événement, réception, fête ou soirée, et aucune sono ni enceinte à l'extérieur : la villa est louée pour des vacances, pas pour un événement.",
     "en": "No events, receptions, parties or gatherings, and no sound system or speakers outdoors: the villa is rented for a holiday, not for an event.",
     "confirm_fr": "Je comprends qu'une fête ou un événement dans la villa entraîne la retenue de la caution de 1 000 € et la fin immédiate du séjour, sans remboursement.",
     "confirm_en": "I understand that a party or event at the villa results in the 1,000 € deposit being withheld and the immediate end of the stay, without refund.",
    ...
    {"key": "bruit", "confirm": True,
     "fr": "Aucune nuisance sonore, de jour comme de nuit : quartier résidentiel calme, voisins proches. Musique à volume modéré à l'intérieur uniquement, silence complet à l'extérieur après 22h.",
     "en": "No noise disturbance, day or night: quiet residential area, close neighbours. Music at moderate volume indoors only, complete silence outdoors after 10 pm.",
    ...
    {"key": "visite", "confirm": False,
     "fr": "Le propriétaire ou son représentant peut passer à tout moment pour vérifier le respect des règles de sécurité et de location, notamment en cas de nuisance sonore.",
     "en": "The owner or their representative may visit at any time to check compliance with the safety and rental rules, notably in case of noise disturbance."},
    {"key": "autres", "confirm": False,
     "fr": "Interdits également : fumer ou vapoter à l'intérieur ; animaux sans accord écrit ; drone ; feux d'artifice et pétards ; camping (tentes, matelas d'appoint) ; objets jetés dans la piscine ou les canalisations ; consommation d'eau excessive.",
     "en": "Also prohibited: smoking or vaping indoors; pets without written agreement; drones; fireworks and firecrackers; camping (tents, extra mattresses); objects thrown into the pool or drains; excessive water use."},
    {"key": "piscine", "confirm": False,
     "fr": "Piscine : douche avant la baignade, et crèmes solaires à filtres minéraux uniquement. Pas d'huile ni de spray : ils troublent l'eau et encrassent la filtration.",
     "en": "Pool: shower before swimming, and mineral-filter sunscreens only. No oil or spray: they cloud the water and clog the filtration.",
    ...
    {"key": "caution", "confirm": False,
     "fr": "Caution de 1 000 € (pré-autorisation bancaire ou dépôt) avant le séjour, retenue en tout ou partie en cas de non-respect des règles ou de dégradation.",
     "en": "1,000 € security deposit (bank pre-authorisation or deposit) before the stay, withheld in full or in part in case of breach of the rules or damage."},
    {"key": "conditions", "confirm": False,
     "fr": "J'ai lu l'ensemble des conditions de location et je les accepte. Si certaines règles ne me conviennent pas, je peux demander l'annulation de la réservation.",
     "en": "I have read all the rental conditions and I accept them. If some rules do not suit me, I can ask for the booking to be cancelled."},
]
