...
ZONES_DEFAULT = [
    ...
    {"key": "UE_OUEST", "label": "Union européenne — Ouest (Chrono Classic)", "countries": ["BE", "LU", "NL", "DE", "IT", "ES", "PT", "AT", "IE"], "product": "classic", "particulier": False, "societe": False, "max_bottles": 18, "multiple": 6, "min_order": None, "vat_required": True,
     "note": "fermée (15/09/2026) : stock en droits acquittés (CRD) → DAES, qui exige l'agrément d'expéditeur certifié d'Alix et un destinataire certifié (prestataire) dans chaque pays ; particuliers : représentant fiscal et garantie par pays"},
