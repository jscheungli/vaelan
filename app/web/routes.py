...
_TILES = [
    ...
    ("owine", "Commandes & stock", "bi-box-seam", "/c/{code}/owine",
     "Commandes Shopify à préparer (cartons, valeur assurée, Chronopost, Alix, client), stock OWINE et dépôt-vente, emballages, tâches."),
